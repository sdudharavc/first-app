...
.service('GsmServices', function ($http, $q, Constants) {
    ...
    var baseUrl = "http://192.168.1.168:88/norlinx-gsmmiddleware/api/dashboard/";
    //var baseUrl = Constants.SERVICE_URL;
    
    this.login= function (inputData) {
        return $http.post(baseUrl + 'auth', inputData);
    }
    
    this.getdashlist = function (inputData) {
        return $http.post(baseUrl + 'dashboardList', {param: inputData});
    };
    ...
    this.getdbsetting = function (inputData) {
        return $http.post(baseUrl + 'getDatabaseSetting', {param: inputData});
    }
    ...
    this.getdefaultdb = function (inputData) {
        return $http.get(baseUrl + 'getdefaultdb', {param: inputData});
    }
